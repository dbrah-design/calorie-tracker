          ...
          <div className="todays-log">
           ...
           <div className="log-food">
            ...
            <div className="log-food-form">
              ...
              <button className="add-food"><span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plus-icon lucide-plus plus-icon"><path d="M5 12h14"/><path d="M12 5v14"/></svg></span> Add Food</button>
